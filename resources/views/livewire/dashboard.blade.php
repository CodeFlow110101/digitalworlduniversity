...
<div class="text-[#131e30] grid grid-cols-1 gap-8 sm:gap-20">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-20 text-center font-bold text-xl lg:text-2xl">
        ...
        <div class="bg-[#d6dcde] rounded-2xl py-8 lg:py-12">{{$days_remaining}} Days Till Expiry</div>
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-20 text-center font-bold text-xl lg:text-2xl">
        <div class="bg-[#d6dcde] rounded-2xl py-8 lg:py-12">Referral Income: ${{$user->referral_income}}</div>
        <div class="bg-[#d6dcde] rounded-2xl py-8 lg:py-12">Task Income: ${{$user->task_income}}</div>
    </div>
