...
<div>
    <div class="w-full h-min grid grid-cols-1 gap-6">
        ...
        <div>
            <div class="relative">
                <input wire:model="price" type="number" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-[#131e30] dark:text-[#DDE6ED] bg-transparent rounded-lg border-2 border-[#131e30] dark:border-[#DDE6ED] appearance-none focus:outline-none focus:ring-0 peer" placeholder=" " />
