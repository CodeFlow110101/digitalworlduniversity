        ...
        <div class="grow relative" x-data="{ height: 0 }" x-resize="height = $height">
            <div class="overflow-y-auto inset-x-0 absolute" :style="'height: ' + height + 'px;'">
                <div class="grid grid-cols-1 gap-3 py-4">
                    ...
                    <a href="/admin-panel" wire:navigate class="flex justify-start items-center gap-2 lg:mx-4 mx-4 xl:mx-8 text-center xl:text-left py-2 lg:px-2 xl:px-4 group @if(str_contains($path, 'admin-panel')) bg-black text-white dark:text-black dark:bg-white @else dark:text-white hover:dark:bg-white dark:hover:text-black hover:bg-black hover:text-white bg-transparent text-black  @endif lg:text-base xl:text-md cursor-pointer tracking-wider transition-all duration-300 rounded-lg font-noramal hover:-translate-x-1 hover:shadow-lg hover:dark:shadow-white hover:shadow-black">
                    ...
                    <a href="/programs" wire:navigate class="flex justify-start items-center gap-2 lg:mx-4 mx-4 xl:mx-8 text-center xl:text-left py-2 lg:px-2 xl:px-4 group @if($path == 'programs' || $path == 'videos' || $path == 'video-player') bg-black text-white dark:text-black dark:bg-white @else dark:text-white hover:dark:bg-white dark:hover:text-black hover:bg-black hover:text-white bg-transparent text-black  @endif lg:text-base xl:text-md cursor-pointer tracking-wider transition-all duration-300 rounded-lg font-noramal hover:-translate-x-1 hover:shadow-lg hover:dark:shadow-white hover:shadow-black">
                    ...
                    <a href="/live-chat" wire:navigate class="flex justify-start items-center gap-2 lg:mx-4 mx-4 xl:mx-8 text-center xl:text-left py-2 lg:px-2 xl:px-4 group @if($path == 'live-chat') bg-black text-white dark:text-black dark:bg-white @else dark:text-white hover:dark:bg-white dark:hover:text-black hover:bg-black hover:text-white bg-transparent text-black  @endif lg:text-base xl:text-md cursor-pointer tracking-wider transition-all duration-300 rounded-lg font-noramal hover:-translate-x-1 hover:-translate-y-1 hover:shadow-lg hover:dark:shadow-white hover:shadow-black">
                        ...
                        <div>Support Live Chat</div>
                    </a>
                    <a href="/earn-money" wire:navigate class="flex justify-start items-center gap-2 lg:mx-4 mx-4 xl:mx-8 text-center xl:text-left py-2 lg:px-2 xl:px-4 group @if($path == 'earn-money') bg-black text-white dark:text-black dark:bg-white @else dark:text-white hover:dark:bg-white dark:hover:text-black hover:bg-black hover:text-white bg-transparent text-black  @endif lg:text-base xl:text-md cursor-pointer tracking-wider transition-all duration-300 rounded-lg font-noramal hover:-translate-x-1 hover:-translate-y-1 hover:shadow-lg hover:dark:shadow-white hover:shadow-black">
                        ...
                        <div>Earn Money Survey</div>
                    </a>
                    <a href="/find-jobs" wire:navigate class="flex justify-start items-center gap-2 lg:mx-4 mx-4 xl:mx-8 text-center xl:text-left py-2 lg:px-2 xl:px-4 group @if($path == 'find-jobs') bg-black text-white dark:text-black dark:bg-white @else dark:text-white hover:dark:bg-white dark:hover:text-black hover:bg-black hover:text-white bg-transparent text-black  @endif lg:text-base xl:text-md cursor-pointer tracking-wider transition-all duration-300 rounded-lg font-noramal hover:-translate-x-1 hover:-translate-y-1 hover:shadow-lg hover:dark:shadow-white hover:shadow-black">
                    ...
                    <a href="/ai-tutor" wire:navigate class="flex justify-start items-center gap-2 lg:mx-4 mx-4 xl:mx-8 text-center xl:text-left py-2 lg:px-2 xl:px-4 group @if($path == 'ai-tutor') bg-black text-white dark:text-black dark:bg-white @else dark:text-white hover:dark:bg-white dark:hover:text-black hover:bg-black hover:text-white bg-transparent text-black  @endif lg:text-base xl:text-md cursor-pointer tracking-wider transition-all duration-300 rounded-lg font-noramal hover:-translate-x-1 hover:-translate-y-1 hover:shadow-lg hover:dark:shadow-white hover:shadow-black">
                    ...
                    <a href="/exam" wire:navigate class="flex justify-start items-center gap-2 lg:mx-4 mx-4 xl:mx-8 text-center xl:text-left py-2 lg:px-2 xl:px-4 group @if($path == 'exam') bg-black text-white dark:text-black dark:bg-white @else dark:text-white hover:dark:bg-white dark:hover:text-black hover:bg-black hover:text-white bg-transparent text-black  @endif lg:text-base xl:text-md cursor-pointer tracking-wider transition-all duration-300 rounded-lg font-noramal hover:-translate-x-1 hover:-translate-y-1 hover:shadow-lg hover:dark:shadow-white hover:shadow-black">
                    ...
                    <a href="/store" wire:navigate class="flex justify-start items-center gap-2 lg:mx-4 mx-4 xl:mx-8 text-center xl:text-left py-2 lg:px-2 xl:px-4 group @if($path == 'store') bg-black text-white dark:text-black dark:bg-white @else dark:text-white hover:dark:bg-white dark:hover:text-black hover:bg-black hover:text-white bg-transparent text-black  @endif lg:text-base xl:text-md cursor-pointer tracking-wider transition-all duration-300 rounded-lg font-noramal hover:-translate-x-1 hover:-translate-y-1 hover:shadow-lg hover:dark:shadow-white hover:shadow-black">
