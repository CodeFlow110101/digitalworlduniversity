...
<div>
    <div class="w-full h-min grid grid-cols-1 gap-6">
        ...
        <div class="flex justify-center w-full">
            <button wire:loading.class="pointer-events-none" wire:click="submit" class="bg-[#131e30] dark:bg-[#DDE6ED] px-8 py-4 text-lg font-semibold rounded-lg text-[#d6dcde] dark:text-[#131e30]">
                <div wire:loading.remove wire:target="submit">Submit</div>
                <div wire:loading wire:target="submit" class="flex justify-center">
