...
<div class="h-full w-full fixed top-0 bg-black/50 @if(!$show_modal) hidden @endif flex justify-center items-center">
    <div class="bg-[#d6dcde] dark:bg-gray-800 w-1/2 p-10 rounded-2xl grid grid-cols-1 gap-12">
        <div class="flex justify-between items-center">
            <div class="text-[#131e30] dark:text-[#DDE6ED] capitalize text-2xl font-bold">{{str_replace("-"," ",$modal)}}</div>
