...
<div>
    <button wire:click="$dispatch('show-modal', { modal:'modal-store', args:null, data:null, callback_event:null })" class="fixed z-10 bottom-12 right-12 bg-[#d6dcde] dark:bg-gray-800 text-xl flex justify-between items-center gap-4 rounded-lg py-2 px-4">
        <div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
        ...
        <div class="bg-[#d6dcde] dark:bg-gray-800 rounded-2xl grid grid-cols-1 gap-4">
            <div class="flex items-center justify-center w-full h-48 bg-gray-500 rounded-t-2xl">
                <img src="{{$items->thumbnail_url}}" class="w-full h-full rounded-t-2xl">
            </div>
