...
<div>
    ...
    <div class="text-[#131e30] grid grid-cols-1 gap-6 sm:gap-10 text-xl lg:text-3xl">
        <div class="flex justify-center items-center">
            <div class="grid grid-cols-1 gap-4">
                <div class="flex justify-center">
                    ...
                    @else
                    <svg class="w-24 h-24 lg:w-28 lg:h-28 text-[#131e30]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                ...
                <div class="flex justify-center">
                    <div class="flex justify-between gap-3 font-semibold">
                        <div wire:click="removePhoto" class="bg-[#131e30] px-8 py-4 text-lg font-semibold rounded-lg text-[#d6dcde] cursor-pointer">Remove</div>
                        <div @click="$refs.photo.click()" class="bg-[#131e30] px-8 py-4 text-lg font-semibold rounded-lg text-[#d6dcde] cursor-pointer">Edit</div>
